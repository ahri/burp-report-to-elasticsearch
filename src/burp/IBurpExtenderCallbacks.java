...
public interface IBurpExtenderCallbacks
{
    ...
    /**
     * This method causes Burp to save its current configuration as a JSON string. The saved configuration can
     * be limited to some part of the configuration by providing the first part of the path. For example if the string
     * 'options.connections' is used, then only that part of the configuration will be saved
     *
     * @param  configPaths A list of strings corresponding to the required part of the configuration.
     * @return A Json String representing the current burp configuration.
     */
    String saveJsonConfig(String... configPaths);

    /**
     * This method causes Burp to load a new configuration from the JSON string provided. Any settings
     * not specified in the Map will be left at their current values.
     *
     * @param config A JSON string containing the new configuration.
     */
    void loadJsonConfig(String config);
